...
function domo(){
   ...
   $('*').bind('keydown', 'Ctrl+a', function assets() {
       window.location.href = BASE_URL + '/administrator/articles/add';
       return false;
   });
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', ['Pos Store 2 Ibi Articles']); ?>  (Ctrl+a)" href="<?=  site_url('administrator/articles/add'); ?>"><i class="glyphicon glyphicon-plus" ></i> </a>
                        <?php }) ?>
                        <?php is_allowed('pos_store_2_ibi_articles_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> Pos Store 2 Ibi Articles" href="<?= site_url('administrator/articles/export'); ?>"><i class="fa fa-file-excel-o" ></i> </a>
                        <?php }) ?>
                        <?php is_allowed('pos_store_2_ibi_articles_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> pdf Pos Store 2 Ibi Articles" href="<?= site_url('administrator/articles/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> </a>
                        <?php }) ?>
                     </div>
                  ...
                  <form name="form_pos_store_2_ibi_articles" id="form_pos_store_2_ibi_articles" action="<?= base_url('administrator/articles/index'); ?>">
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <?php foreach($articless as $pos_store_2_ibi_articles): ?>
                        <tr>
                           <td width="5">
                           ...
                           <td>
                              <?php 
                                $user = $this->model_fournisseurs->get_user_info('pos_ibi_categories',$pos_store_2_ibi_articles->ID_CATEGORIE,'ID_CATEGORIE');
                              if($user>0)
                                {
                           ...
                           <td>
                             <?php 
                                $user = $this->model_fournisseurs->get_user_info('pos_ibi_categories',$pos_store_2_ibi_articles->REF_SOUS_CATEGORIE_ARTICLE,'ID_CATEGORIE');
                              if($user>0)
                                {
                          ...
                          <!--  <td><?= _ent($pos_store_2_ibi_articles->SHADOW_PRICE_ARTICLE); ?></td> 
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/articles/view/' . $pos_store_2_ibi_articles->ID_ARTICLE); ?>" class="btn btn-warning btn-sm"><span  class="glyphicon glyphicon-eye-open"></span></a>
                              <?php }) ?>
                              <?php is_allowed('pos_store_2_ibi_articles_update', function() use ($pos_store_2_ibi_articles){?>
                              <a href="<?= site_url('administrator/articles/edit/' . $pos_store_2_ibi_articles->ID_ARTICLE); ?>" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-edit"></span></a>
                              <?php }) ?>
                              <?php is_allowed('pos_store_2_ibi_articles_delete', function() use ($pos_store_2_ibi_articles){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/articles/delete/' . $pos_store_2_ibi_articles->ID_ARTICLE); ?>" class="btn btn-danger btn-sm remove-data"><span class="glyphicon glyphicon-remove"></span></a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/articles');?>" title="<?= cclang('reset_filter'); ?>">
    ...
    $('#apply').click(function(){
      ...
      if (bulk.val() == 'delete') {
         swal({
          ...
          function(isConfirm){
            if (isConfirm) {
               document.location.href = BASE_URL + '/administrator/articles/delete?' + serialize_bulk;      
            }
          });
