               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal" name="form_pos_ibi_clients_groups" id="form_pos_ibi_clients_groups" >
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit pos_ibi_clients_groups (Ctrl+e)" href="<?= site_url('administrator/clients_groups/edit/'.$clients_groups->ID_GROUP); ?>"><i class="fa fa-edit" ></i> <?= cclang('update', ['Pos Ibi Clients Groups']); ?> </a>
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('administrator/clients_groups/'); ?>"><i class="fa fa-undo" ></i> <?= cclang('go_list_button', ['Pos Ibi Clients Groups']); ?></a>
                     </div>
