               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', ['Pos Ibi Categories']); ?>  (Ctrl+a)" href="<?=  site_url('administrator/categories/add'); ?>"><i class="glyphicon glyphicon-plus" ></i> </a>
                        <?php }) ?>
                        <?php is_allowed('pos_ibi_categories_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> Pos Ibi Categories" href="<?= site_url('administrator/categories/export'); ?>"><i class="fa fa-file-excel-o" ></i> </a>
                        <?php }) ?>
                        <?php is_allowed('pos_ibi_categories_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> pdf Pos Ibi Categories" href="<?= site_url('administrator/categories/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> </a>
                        <?php }) ?>
                     </div>
                  ...
                  <form name="form_pos_ibi_categories" id="form_pos_ibi_categories" action="<?= base_url('administrator/categories/index'); ?>">
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <?php foreach($categoriess as $pos_ibi_categories): ?>
                        <tr>
                           <td width="5">
                        ...
                        <!-- Ce code nous permet d'afficher les sous categories-->
                           <td>
                             ...
                             <?php 
                                $user = $this->model_fournisseurs->get_user_info('pos_ibi_categories',$pos_ibi_categories->PARENT_REF_ID_CATEGORIE,'ID_CATEGORIE');
                              if($user>0)
                                {
                           ...
                           <td>
                            ...
                            <td width="200">
                              ...
                              <a href="<?= site_url('administrator/categories/view/' . $pos_ibi_categories->ID_CATEGORIE); ?>" class="btn btn-warning btn-sm"><span  class="glyphicon glyphicon-eye-open"></span></a>
                              <?php }) ?>
                              <?php is_allowed('pos_ibi_categories_update', function() use ($pos_ibi_categories){?>
                              <a href="<?= site_url('administrator/categories/edit/' . $pos_ibi_categories->ID_CATEGORIE); ?>" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-edit"></span></a>
                              <?php }) ?>
                              <?php is_allowed('pos_ibi_categories_delete', function() use ($pos_ibi_categories){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/categories/delete/' . $pos_ibi_categories->ID_CATEGORIE); ?>" class="btn btn-danger btn-sm remove-data"><span class="glyphicon glyphicon-remove"></span></a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
