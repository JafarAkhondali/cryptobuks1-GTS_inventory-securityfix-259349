               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal" name="form_pos_ibi_fournisseurs" id="form_pos_ibi_fournisseurs" >
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($fournisseurs->DATE_CREATION); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?php 
                              $user = $this->model_fournisseurs->get_user_info('aauth_users',$fournisseurs->AUTHOR,'id');
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit pos_ibi_fournisseurs (Ctrl+e)" href="<?= site_url('administrator/fournisseurs/edit/'.$fournisseurs->ID); ?>"><i class="fa fa-edit" ></i> <?= cclang('update', ['Fournisseurs']); ?> </a>
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('administrator/fournisseurs/'); ?>"><i class="fa fa-undo" ></i> <?= cclang('go_list_button', ['Fournisseurs']); ?></a>
                     </div>
