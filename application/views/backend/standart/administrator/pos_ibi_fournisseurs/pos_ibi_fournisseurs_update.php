                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/pos_ibi_fournisseurs/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="NOM" id="NOM" placeholder="NOM" value="<?= set_value('NOM', $pos_ibi_fournisseurs->NOM); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="BP" id="BP" placeholder="BP" value="<?= set_value('BP', $pos_ibi_fournisseurs->BP); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="TEL" id="TEL" placeholder="TEL" value="<?= set_value('TEL', $pos_ibi_fournisseurs->TEL); ?>">
                                <small class="info help-block">
