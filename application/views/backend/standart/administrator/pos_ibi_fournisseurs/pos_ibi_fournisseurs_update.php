                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/pos_ibi_fournisseurs/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="NOM" id="NOM" placeholder="Nom Du Fournisseur" value="<?= set_value('NOM', $pos_ibi_fournisseurs->NOM); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="BP" id="BP" placeholder="Boite Postal(BP)" value="<?= set_value('BP', $pos_ibi_fournisseurs->BP); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="TEL" id="TEL" placeholder="Telephone" value="<?= set_value('TEL', $pos_ibi_fournisseurs->TEL); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="EMAIL" id="EMAIL" placeholder="Email" value="<?= set_value('EMAIL', $pos_ibi_fournisseurs->EMAIL); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="DESCRIPTION" name="DESCRIPTION" rows="10" cols="80"> <?= set_value('DESCRIPTION', $pos_ibi_fournisseurs->DESCRIPTION); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
