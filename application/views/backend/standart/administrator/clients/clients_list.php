...
function domo(){
   ...
   $('*').bind('keydown', 'Ctrl+a', function assets() {
       window.location.href = BASE_URL + '/administrator/clients/add';
       return false;
   });
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', ['Clients']); ?>  (Ctrl+a)" href="<?=  site_url('administrator/clients/add'); ?>"><i class="glyphicon glyphicon-plus"></i> </a>
                        <?php }) ?>
                        <?php is_allowed('pos_ibi_clients_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> Pos Ibi Clients" href="<?= site_url('administrator/clients/export'); ?>"><i class="fa fa-file-excel-o" ></i> </a>
                        <?php }) ?>
                        <?php is_allowed('pos_ibi_clients_export', function(){?>
                  ...
                  <form name="form_pos_ibi_clients" id="form_pos_ibi_clients" action="<?= base_url('administrator/clients/index'); ?>">
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <?php foreach($clientss as $pos_ibi_clients): ?>
                        <tr>
                           <td width="5">
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/clients/view/' . $pos_ibi_clients->ID_CLIENT); ?>" class="btn btn-warning btn-sm"><span  class="glyphicon glyphicon-eye-open"></span></a>
                              <?php }) ?>
                              <?php is_allowed('pos_ibi_clients_update', function() use ($pos_ibi_clients){?>
                              <a href="<?= site_url('administrator/clients/edit/' . $pos_ibi_clients->ID_CLIENT); ?>" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-edit"></span></a>
                              <?php }) ?>
                              <?php is_allowed('pos_ibi_clients_delete', function() use ($pos_ibi_clients){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/clients/delete/' . $pos_ibi_clients->ID_CLIENT); ?>" class="btn btn-danger btn-sm remove-data"><span class="glyphicon glyphicon-remove"></span></a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/clients');?>" title="<?= cclang('reset_filter'); ?>">
