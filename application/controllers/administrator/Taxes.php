			...
			if ($save_taxes) {
				if ($this->input->post('save_type') == 'stay') {
					...
					$this->data['message'] = cclang('success_save_data_stay', [
						anchor('administrator/taxes/edit/' . $save_taxes, 'Edit Pos Ibi Taxes'),
						anchor('administrator/taxes', ' Go back to list')
					]);
				} else {
					set_message(
            		...
            		$this->data['success'] = true;
					$this->data['redirect'] = base_url('administrator/taxes');
				}
			} else {
				if ($this->input->post('save_type') == 'stay') {
