...
class Model_pos_ibi_clients extends MY_Model {
	...
	private $field_search 	= ['NOM_CLIENT', 'PRENOM_CLIENT', 'TEL_CLIENT', 'EMAIL_CLIENT', 'DESCRIPTION_CLIENT', 'DATE_NAISSANCE_CLIENT', 'CITY_CLIENT', 'COUNTRY_CLIENT', 'COMPANY_NAME_CLIENT', 'DATE_CREATION_CLIENT', 'DATE_MOD_CLIENT', 'REF_GROUP_CLIENT', 'AUTHOR_CLIENT'];
